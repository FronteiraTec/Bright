...
public class AttackController : MonoBehaviour
{
  ...
  [SerializeField] private float maxComboDelay = 0.5f;
   // keep track of how many clicks in range(0,2)
  ...
  [SerializeField] private float WeakAttackStaminaCost = 0;
  ...
  {
    if(staminaBar.GetStamina() > amount)
    {
  ...
  private void Combo()
  {
    if(staminaBar.GetStamina() > WeakAttackStaminaCost)
    {
